    ...
    return (
        <div>
            <div className="my-5 lg:my-14 px-6 lg:px-0">
                <h1 className="text-4xl md:text-5xl lg:text-5xl font-rancho font-semibold text-center">Popular <span className="bg-gradient-to-tr from-[#54C2C3] to-[#00463E] text-transparent bg-clip-text">Services</span></h1>
