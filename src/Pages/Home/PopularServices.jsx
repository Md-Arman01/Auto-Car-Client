    ...
    return (
        <div>
            <div className="my-5 lg:my-14 px-6 lg:px-0">
                <h1 className="text-4xl md:text-5xl lg:text-5xl font-rancho font-semibold text-center dark:text-white">Popular <span className="bg-gradient-to-tr from-[#54C2C3] to-[#00463E] text-transparent bg-clip-text">
          ...
          />
                ...
                <p className="text-sm text-gray-500 dark:text-gray-300 text-center mx-auto md:w-[650px] my-5">It is a cost-effective and flexible alternative to traditional taxi services, with options like Uber, Lyft, and others available in many locations.</p>
            </div>
