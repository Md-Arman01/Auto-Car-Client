    ...
    <div className="container mx-auto lg:mt-10 mb-5 lg:mb-0">
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-5 lg:gap-0 px-7 lg:px-0 ">
        <div className="space-y-5">
          <h1 className="text-3xl md:text-4xl lg:text-6xl  md:w-[650px] font-rancho font-semibold">Scheduling automation platform to enhance your online rides</h1>
          <p className="text-gray-500 font-semibold  md:w-[550px]">Schedule is a simple appointment booking platform that facilitates online ride booking and helps you manage your  in moving a smart way.</p>
          <button
