...
const ServicesCard = ({service}) => {
  ...
  return (
    <div >
      ...
      <div className="relative flex flex-col md:flex-row md:h-[350px] rounded-xl bg-white bg-clip-border text-gray-700 shadow-md hover:shadow-2xl hover:shadow-[#00463E]">
