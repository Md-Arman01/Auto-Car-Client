                ...
                <div className="mb-1">
                  <div className="flex items-center justify-center gap-5 mb-4">
                    <img
                      ...
                      alt=""
                    />
                    <h1 className="text-2xl font-semibold">{provider_name}</h1>
                  </div>
                  <hr />
                </div>
      ...
      <div>
        ...
        <form onSubmit={handleBookService}>
          ...
          <div className="grid grid-cols-2 gap-5 my-5">
            <div>
              <h1 className="md:text-lg font-medium mb-2">Services Name</h1>
              <input
            ...
            <div>
              <h1 className="md:text-lg font-medium mb-2">Provider Email</h1>
              <input
            ...
            <div>
              <h1 className="md:text-lg font-medium mb-2">User Email</h1>
              <input
            ...
            <div>
              <h1 className="md:text-lg font-medium mb-2">Service Price</h1>
              <input
                placeholder={price}
                className="input input-bordered w-full"
                disabled
            ...
            <div>
            <h1 className="md:text-lg font-medium mb-2">Taking Date</h1>
              <input
                type="date"
                name="date"
                required
