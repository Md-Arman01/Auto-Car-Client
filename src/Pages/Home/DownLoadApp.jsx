...
const DownLoadApp = () => {
    return (
        <div className="container mx-auto flex items-center justify-center my-20">
            <img className="w-[400px] rounded-2xl" src="https://i.ibb.co/W6c492N/side-view-hands-holding-smartphone-500.webp" alt="" />
            <div className="bg-[#FF9B23] h-[380px] w-[800px] p-20">
