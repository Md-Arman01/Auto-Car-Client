...
const DownLoadApp = () => {
    return (
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center my-5 lg:my-20">
            ...
            <div className="bg-[#FF9B23] md:h-[380px] md:w-[800px] p-10 md:p-20">
                <h1 className="text-2xl md:text-4xl lg:text-5xl mb-5 text-white font-semibold">
                  
                  <Typewriter
            words={['Download Our App']}
            loop={100}
            cursor
            cursorStyle=''
            typeSpeed={70}
