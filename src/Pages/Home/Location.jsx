    ...
    <div>
      <div
        ...
        <div className="flex gap-32">
          <div>
            <h1 className="text-white text-4xl font-semibold">We Have Now <span className="text-orange-500">2000</span> Locations</h1>
            <p className="text-base text-gray-200  my-3 w-[650px]">
          ...
          <div className='flex gap-10 items-end'>
            <div>
                <h1 className='text-5xl text-orange-500'>1470</h1>
                <p className='text-gray-200 mt-3'>Rental Cars Fleet</p>
            </div>
            <div>
                <h1 className='text-5xl text-orange-500'>265</h1>
                <p className='text-gray-200 mt-3'>5 Star Reviews</p>
            </div>
            <div>
                <h1 className='text-5xl text-orange-500'>308</h1>
