      ...
      <div>
        <div>
          <div className=" flex justify-center mt-14 md:mt-20 lg:mt-28 px-5 md:px-0 w-[400px]">
            <div className="dark:bg-slate-700 relative flex w-full md:w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                ...
                <div className="flex flex-col gap-4 p-6">
                  ...
                  <div className="-ml-2.5">
                    <div className="inline-flex items-center">
                      ...
                      <label
                        className="dark:text-white mt-px cursor-pointer select-none font-light text-gray-700"
                        htmlFor="checkbox">
